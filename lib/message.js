...
const getSigninUrl = (openUserId) => {
  return `${config.uiServer}#/user/${openUserId}`;
};
...
const getSubscribeMessage = (openUserId) => {
  return `Weclome You! To make sure you can recive the news and the notifications, please do the <a href="${getSigninUrl(openUserId)}">Authorization Binding</a>, then you can:
